...
\begin{figure}[!ht]
  \centering
  \includegraphics[width=5cm]{zigzag0.1mm} \quad \includegraphics[width=5cm]{zigzag1mm}
  \caption{\CJK{UTF8}{gbsn}{zigzag hatching with 0.1mm accuracy}}
  \caption{\CJK{UTF8}{gbsn}{zigzag hatching with 1mm accuracy}}
\end{figure}

When the accuracy is 1mm, the total length of the curve is 918.98mm, the number of parallel lines is 89, and the average elapsed time is (6.89*10^3\pm 30) mm. When the accuracy is 0.1mm, the total length of the curve is 10022.71mm, the number of parallel lines is 911, and the average elapsed time is (7.75*10^3\pm 40) mm.
...
\begin{figure}[!ht]
  \centering
  \includegraphics[width=5cm]{contour0.1mm} \quad \includegraphics[width=5cm]{contour1mm}
  \caption{\CJK{UTF8}{gbsn}{zigzag hatching with 0.1mm accuracy}}
  \caption{\CJK{UTF8}{gbsn}{zigzag hatching with 1mm accuracy}}
\end{figure}

When the accuracy is 1mm, the total length of the curve is 985.26mm, the number of circles is 11, and the average elapsed time is (2.91*10^4\pm 200) mm.
