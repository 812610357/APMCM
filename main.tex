...
When the accuracy is 1mm, the total length of the curve is 985.26mm, the number of circles is 11, and the average elapsed time is (2.91*10^4\pm 200) mm. When the accuracy is 0.1mm, the total length of the curve is 10060.39mm, the number of circles is 129, and the average elapsed time is (6.25*10^5\pm 2000) mm.
